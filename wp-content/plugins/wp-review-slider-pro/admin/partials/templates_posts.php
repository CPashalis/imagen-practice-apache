...
<tr class="wprevpro_row">
				...
				?>
								...
								<div class="wprevpre_temp_label_row">
									<div id="borderdiv" <?php if($currenttemplate->style=='2' && $currenttemplate->style=='4' && $currenttemplate->style=='5'){echo 'class="bordercolor245"';} else {echo 'class="bordercolorhide"'; } ?>>
									...
									<span id="bordercolor245span" <?php if($currenttemplate->style!='2' && $currenttemplate->style!='4' && $currenttemplate->style!='5'){echo "style=display:none;";} ?>>
...
<tr class="wprevpro_row nopaddingtd">
			...
			<tr class="wprevpro_row">
				<th scope="row">
					<?php _e('Add Avg/Total Header', 'wp-review-slider-pro'); ?><a class="wprevpro_helpicon_p wprevpro_btnicononlyhelp dashicons-before dashicons-editor-help"></a>
				</th>
				<td>
		...
		<tbody>
			...
			<tr class="wprevpro_row">
						...
						<div class="divtemplatestyles">
							...
							<p id="snippetsettingsdesc" class="description" style="display: block;font-style: italic;"><?php _e('<b>Note:</b> Only turn this on for one review or badge template per a page or you will get duplicate rich snippets, which Google may not like.', 'wp-review-slider-pro'); ?> </p>
