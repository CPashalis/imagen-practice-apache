 ...
 //========================
	...
	if (isset($_POST['wprevpro_submittemplatebtn'])){
		...
		//$typearray = unserialize(WPREV_TYPE_ARRAY);
		 ...
		 $templatemiscarray['si_custom2_linkurl']=sanitize_text_field($_POST['wprevpro_badge_misc_si_custom2_linkurl']);
		 $templatemiscarray['si_custom2_imgurl']=sanitize_text_field($_POST['wprevpro_badge_misc_si_custom2_imgurl']);
		 $templatemiscarray['si_custom3_linkurl']=sanitize_text_field($_POST['wprevpro_badge_misc_si_custom3_linkurl']);
