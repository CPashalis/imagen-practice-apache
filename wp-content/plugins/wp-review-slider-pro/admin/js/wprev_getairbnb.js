...
function getairbnbreviewsfunction(myurlnum) {

	//launch pop-up for progress messages
	openpopup(adminjs_script_vars.popuptitle, adminjs_script_vars.popupmsg+" "+adminjs_script_vars.popupmsg1+"</br></br>","");
	var myVartimer = setInterval(myTimer, 1000);
	//var myurlnum = '1';

		var data = {
			action		: 'wpfb_airbnb_reviews',
			urlnum	:	myurlnum,
