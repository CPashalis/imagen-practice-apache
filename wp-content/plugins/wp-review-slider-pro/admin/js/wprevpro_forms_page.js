	...
	$(function(){
		...
		$( ".wprevpro_displayshortcode" ).on("click",function() {
		  ...
		  if(ttype=="widget"){
			...
			openpopup(adminjs_script_vars.popuptitle2, '<p>'+adminjs_script_vars.popupmsg2a+' </br></br><b>[wprevpro_useform tid="'+fid+'"]</b></br></br><i>'+adminjs_script_vars.popupmsg2b+'</i> </br></br>[wprevpro_useform tid="'+fid+'" wppl="yes"]</br></br>'+adminjs_script_vars.popupmsg2c+'</br> http://mywebsite.com/?wppl=yes</br>http://mywebsite.com/?review=1</br>'+adminjs_script_vars.popupmsg2d+'</br></br><i>'+adminjs_script_vars.popupmsg2b1+'</i> </br></br>[wprevpro_useform tid="'+fid+'" wppl="auto"]</br></br>'+adminjs_script_vars.popupmsg2c1+'</br> http://mywebsite.com/?wppl=auto</br>http://mywebsite.com/?review=2</br></br>'+adminjs_script_vars.popupmsg2d1+'</p>', '');
		  }
		...
		function updateformfields(formobject){
			...
			for (var i = 0; i < arrayLength; i++) {
				...
				if(ffields_array[i].name.includes("custom_select_") ){
					...
					hidethis_rrthumb = "hideme";	//hiding default values
				}
			...
			var newfieldhtml = '<div id="outerdivaddinput"><span id="addforminputbtn" class="linkaddspan">Add Form Input</span>	\
								...
								<select name="newinputtypesel" id="newinputtypesel">	\
									  ...
									  <option value="select_page">Page Select</option>	\
		...
		$('#newformform').on( "click", "#addforminputbtnsubmit", function() {
			...
			if(inputtype=='checkbox'){
				...
				var display_placeholder = 'hideme';
				var display_dfv = 'hideme';
				var display_dsv = 'hideme';
			}
			var custombefore = '';
			if(inputtype=='media'){
				custombefore = 'Enter the image or YouTube url. You can also upload an image, but not a video.';
			}
			newinputhtml = '<li id="field-'+lastid+'" class="custominputli" style="display:none;"><div class="custom-field-header"><span class="link open" title="click to open or close"><a class="field" href="#">Custom '+labeltext+'</a><span class="handle ui-sortable-handle" title="drag and drop to reorder"></span><span class="toggle"></span></span></div><div class="custom-field" style="display: none;"><table class="field-table"><tbody><tr class="hideme"><th>Type</th><td>text</td></tr>	\
