(function( $ ) {
	...
	$(function(){
		...
		function resetcolors(){
				...
				} else if(templatenum=='2' || templatenum=='5' || templatenum=='6' || templatenum=='7' || templatenum=='8' || templatenum=='9' || templatenum=='10' || templatenum=='11'){
					$( "#wprevpro_template_misc_bradius" ).val('0');
					if(templatenum=='10'){
		...
		function changepreviewhtml(){
			...
			var bcolor = $( "#wprevpro_template_misc_bcolor" ).val();	//only using this on 2,4,5
			...
			//hide or show bcolor option if this is 2,4,5
			if(templatenum==2 || templatenum==4 || templatenum==5){
				$( "#bordercolor245span" ).show();
				//change class from bordercolorhide to bordercolor245
				$('#borderdiv').addClass('bordercolor245').removeClass('bordercolorhide');
			} else {
				$( "#bordercolor245span" ).hide();
				$('#borderdiv').addClass('bordercolorhide').removeClass('bordercolor245');
			}
			...
			let bcolorresult = bcolor.includes(", 0 )");
				...
				if(templatenum=='1'){
					...
					$( '.wprev_preview_bg1' ).css( "border", '1px solid '+bcolor );
					}
					...
					$( "#wprevpro_template_preview" ).html(prestyle+style11html);
					$( ".wprevpre_bgcolor2" ).show();
					$( ".wprevpre_tcolor3" ).hide();
					$( '.wprev_preview_bg1' ).css( "border", '1px solid '+bg2 );
				}
