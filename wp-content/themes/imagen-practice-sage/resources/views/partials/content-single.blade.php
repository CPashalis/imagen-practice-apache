...
<div class="page-section relative">
  <div class="w-full h-96 bg-cover bg-center z-0" style="background-image: url({{get_the_post_thumbnail_url()}})"></div>
        ...
        <footer>
          ...
          <div class="post-navigation my-10">
            <div class="row">
              ...
              <div class="col-6">
                @if (!empty($prevID))
                <a href="{{get_permalink($prevID)}}" title="{{get_the_title($prevID)}}" class="text-primary">
              ...
              <div class="text-right col-6">
                @if (!empty($nextID))
                <a href="{{ get_permalink($nextID) }}" title="{{ get_the_title($nextID) }}">
