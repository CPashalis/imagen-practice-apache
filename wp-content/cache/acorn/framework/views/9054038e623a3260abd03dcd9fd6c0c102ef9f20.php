  ...
  <div class="xl:container mx-auto px-6">
    <div class="flex justify-between items-center py-6 lg:justify-start lg:space-x-10">
      ...
      <div class="-mr-2 -my-2 lg:hidden flex">
        ...
        <?php if($obLink): ?>
        <a href="<?php echo e($obLink); ?>" type="button" class="relative px-2 items-center justify-center text-white text-center" style="height: 40px; width: 60px;">
      ...
      <div class="hidden lg:flex items-center justify-end lg:flex-1 lg:w-0">
        ...
        <?php ($obLink = get_field('schedule_form_outbound_link', 'option')); ?>
        <?php if($obLink): ?>
        <a href="<?php echo e($obLink); ?>" type="button" class="ml-4 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-sm shadow-sm text-xs font-medium text-white bg-primary text-left">
...
</header><?php /**PATH /var/www/html/wp-content/themes/imagen-practice-sage/resources/views/sections/header.blade.php ENDPATH**/ ?>