        ...
        <div class="relative container mx-auto z-10 p-6">
          <div class="grid grid-cols-2 gap-5 content-center">
            <div class="col-span-1">
              ...
              <?php if($job): ?><h3 class="text-xl font-medium relative md:mb-4 mb-2"><?php echo $job; ?></h2><?php endif; ?>
...
<?php endif; ?><?php /**PATH /var/www/html/wp-content/themes/imagen-practice-sage/resources/views/components/dentist-modal.blade.php ENDPATH**/ ?>