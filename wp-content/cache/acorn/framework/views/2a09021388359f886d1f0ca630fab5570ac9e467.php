                ...
                <div class="relative mx-auto z-10 md:p-6 py-6">
                    <div class="content-center">
                        <div class="p-6 text-center">
                            <h2 class="<?php echo e($tw['h2']); ?>"><?php echo $initial['title']; ?></h2>
        ...
        <div class="grid grid-cols-12 gap-5 content-center xl:container mx-auto p-6 relative">
            <div class="xl:col-span-10 xl:col-start-2 col-span-12">
                <div class="relative mx-auto z-10 md:p-6 py-6">
                    <div class="content-center">
                        <div class="p-6 text-center">
                            <h2 class="<?php echo e($tw['h2']); ?>"><?php echo $patient['title']; ?></h2>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\imagen3\wp-content\themes\imagen-practice-sage\resources\views/new-patient.blade.php ENDPATH**/ ?>