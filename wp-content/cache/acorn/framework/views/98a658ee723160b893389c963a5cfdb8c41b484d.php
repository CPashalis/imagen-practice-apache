        ...
        <div class="md:p-6 mx-auto">
          <div class="grid grid-cols-12 gap-5">
            <div class="col-span-12 md:col-span-9 md:text-left text-center">
              ...
              <a href="<?php echo e($team['team_button_url']); ?>" target="_blank" class="mt-6 bg-white whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-sm shadow-sm text-xs font-medium text-white uppercase text-dark"><?php echo e($team['team_button_label']); ?></a>
            </div>
        ...
        <div class="md:p-6 mx-auto md:text-left text-center">
          ...
          <div class="grid grid-cols-12 gap-5">
            ...
            <div class="col-span-12 md:col-span-6 lg:col-span-3 md:text-left text-center">
              ...
              <?php if($flogo): ?><a href="https://www.imagendentalpartners.com/" target="_blank" rel="noopener noreferrer"><img style="max-width:100px;" src="<?php echo e($flogo['url']); ?>" alt="Imagen Dental Partners" class="inline-block"/></a><?php endif; ?>
            </div>
          </div>
        </div>
      </div>
...
<?php /**PATH /var/www/html/wp-content/themes/imagen-practice-sage/resources/views/sections/footer.blade.php ENDPATH**/ ?>