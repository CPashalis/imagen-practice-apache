...
<div class="accordion-item">
  <h3 class="accordion-header mb-2 bg-light p-6 relative">
    <button class="
      accordion-button
      relative
      flex
    ...
    " type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true"
      aria-controls="collapseOne"><?php echo $title; ?>
...
</div>  <?php /**PATH C:\xampp\htdocs\imagen3\wp-content\themes\imagen-practice-sage\resources\views/components/service-content-accordion.blade.php ENDPATH**/ ?>