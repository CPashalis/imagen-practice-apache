...
?>
<div class="col-span-<?php echo e($column1); ?> <?php echo $columnOrder ?>">
    <div class="<?php echo e($align); ?> <?php echo e(($bg) ? 'p-6':'py-6 md:p-6'); ?>">
...
</div><?php /**PATH /var/www/html/wp-content/themes/imagen-practice-sage/resources/views/components/includes/section-content.blade.php ENDPATH**/ ?>