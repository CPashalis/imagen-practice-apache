    ...
    <div class="grid grid-cols-5 gap-5 content-center">
      <div class="md:col-span-3 md:col-start-2 col-span-10">
        <div class="text-center">
          ...
          <h2 class="<?php echo e($tw['h1']); ?> text-secondary"><?php echo $title; ?></h2>
          <div class="mb-10 formatted"><?php echo $description; ?></div>
...
<?php /**PATH C:\xampp\htdocs\imagen3\wp-content\themes\imagen-practice-sage\resources\views/components/callout.blade.php ENDPATH**/ ?>